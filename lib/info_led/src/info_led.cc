...
// 预定义的信息类型模式定义
const BlinkUnit InfoLED::kOkPattern[2] = {
    {0.5, true}, {0.5, false}
};

const BlinkUnit InfoLED::kWarningPattern[2] = {
    {0.2, true}, {0.2, false}
};

const BlinkUnit InfoLED::kErrorPattern[6] = {
    {1.0, true},
    {0.5, false},
    {0.2, true},
    {0.2, false},
...
const BlinkUnit InfoLED::kFatalErrorPattern[8] = {
    {0.2, true},
    {0.2, false},
    {0.2, true},
    {0.2, false},
