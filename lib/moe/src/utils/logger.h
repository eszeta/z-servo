...
#define LOG_DEBUG(format, ...)                                                                   \
  do {                                                                                           \
    if (::moe::utils::Logger::ShouldOutput(::moe::utils::LogLevel::kDebug)) {              \
      ::moe::utils::Logger::Printf(::moe::utils::LogLevel::kDebug, format, ##__VA_ARGS__); \
    }                                                                                            \
  } while (0)
...
#define LOG_INFO(format, ...)                                                                   \
  do {                                                                                          \
    if (::moe::utils::Logger::ShouldOutput(::moe::utils::LogLevel::kInfo)) {              \
      ::moe::utils::Logger::Printf(::moe::utils::LogLevel::kInfo, format, ##__VA_ARGS__); \
    }                                                                                           \
  } while (0)
...
#define LOG_WARN(format, ...)                                                                   \
  do {                                                                                          \
    if (::moe::utils::Logger::ShouldOutput(::moe::utils::LogLevel::kWarn)) {              \
      ::moe::utils::Logger::Printf(::moe::utils::LogLevel::kWarn, format, ##__VA_ARGS__); \
    }                                                                                           \
  } while (0)
...
#define LOG_ERROR(format, ...)                                                                   \
  do {                                                                                           \
    if (::moe::utils::Logger::ShouldOutput(::moe::utils::LogLevel::kError)) {              \
      ::moe::utils::Logger::Printf(::moe::utils::LogLevel::kError, format, ##__VA_ARGS__); \
    }                                                                                            \
  } while (0)
...
#define LOG_DEBUG_IF(condition, format, ...)                                                       \
  do {                                                                                             \
    if ((condition) && ::moe::utils::Logger::ShouldOutput(::moe::utils::LogLevel::kDebug)) { \
      ::moe::utils::Logger::Printf(::moe::utils::LogLevel::kDebug, format, ##__VA_ARGS__);   \
    }                                                                                              \
  } while (0)
...
#define LOG_INFO_IF(condition, format, ...)                                                       \
  do {                                                                                            \
    if ((condition) && ::moe::utils::Logger::ShouldOutput(::moe::utils::LogLevel::kInfo)) { \
      ::moe::utils::Logger::Printf(::moe::utils::LogLevel::kInfo, format, ##__VA_ARGS__);   \
    }                                                                                             \
  } while (0)
...
#define LOG_WARN_IF(condition, format, ...)                                                       \
  do {                                                                                            \
    if ((condition) && ::moe::utils::Logger::ShouldOutput(::moe::utils::LogLevel::kWarn)) { \
      ::moe::utils::Logger::Printf(::moe::utils::LogLevel::kWarn, format, ##__VA_ARGS__);   \
    }                                                                                             \
  } while (0)
...
#define LOG_ERROR_IF(condition, format, ...)                                                       \
  do {                                                                                             \
    if ((condition) && ::moe::utils::Logger::ShouldOutput(::moe::utils::LogLevel::kError)) { \
      ::moe::utils::Logger::Printf(::moe::utils::LogLevel::kError, format, ##__VA_ARGS__);   \
    }                                                                                              \
  } while (0)
