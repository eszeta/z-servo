...
constexpr Register Regs::kGoalAcceleration;
constexpr Register Regs::kGoalPositionL;
constexpr Register Regs::kGoalPositionH;
constexpr Register Regs::kGoalTimeL;
constexpr Register Regs::kGoalTimeH;
constexpr Register Regs::kGoalVelocityL;
constexpr Register Regs::kGoalVelocityH;
