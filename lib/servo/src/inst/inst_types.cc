...
constexpr Register Regs::kPosPidLimit;
...
constexpr Register Regs::kAsynWriteSt;
...
constexpr uint8_t RegsDefaultValues::kDefResponseLevel;
...
constexpr uint8_t RegsDefaultValues::kDefPosPidKp;
constexpr uint8_t RegsDefaultValues::kDefPosPidKd;
constexpr uint8_t RegsDefaultValues::kDefPosPidKi;
constexpr uint8_t RegsDefaultValues::kDefMinStartupForce;
constexpr uint8_t RegsDefaultValues::kDefPosPidLimit;
...
constexpr uint8_t RegsDefaultValues::kDefVelPidKp;
constexpr uint8_t RegsDefaultValues::kDefOvercurrentProtectionTime;
constexpr uint8_t RegsDefaultValues::kDefVelPidKi;
