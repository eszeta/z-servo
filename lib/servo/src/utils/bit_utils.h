 ...
 */
template <typename T>
static constexpr T GetValue(const T data, const T mask) noexcept {
  return data & mask;
}
 ...
 */
template <typename T>
static constexpr bool IsMaskSet(const T data, const T mask) noexcept {
  return (data & mask) != 0;
}
 ...
 */
template <typename T>
static constexpr bool IsBitSet(const T data, const uint8_t idx) noexcept {
  return (data & (1 << idx)) != 0;
}
 ...
 */
template <typename T>
static constexpr T SetMaskBit(const T data, const T mask) noexcept {
  return data | mask;
}
 ...
 */
template <typename T>
static constexpr T SetBit(const T data, const uint8_t idx) noexcept {
  return data | (1 << idx);
}
 ...
 */
template <typename T>
static constexpr T ClearMaskBit(const T data, const T mask) noexcept {
  return data & ~mask;
}
 ...
 */
template <typename T>
static constexpr T ClearBit(const T data, const uint8_t idx) noexcept {
  return data & ~(1 << idx);
}
 ...
 */
template <typename T>
static constexpr T ToggleMaskBit(const T data, const T mask) noexcept {
  return data ^ mask;
}
 ...
 */
template <typename T>
static constexpr T ToggleBit(const T data, const uint8_t idx) noexcept {
  return data ^ (1 << idx);
}
 ...
 * @return 原码值（uint16_t，最高位为符号位）
 */
static constexpr uint16_t TwosToSign(const int16_t value) noexcept {
 ...
 * @return 补码值（int16_t）
 */
static constexpr int16_t SignToTwos(const uint16_t value) noexcept {
