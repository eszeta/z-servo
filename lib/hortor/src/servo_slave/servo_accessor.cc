...
// #include "servo_accessor.h"
// namespace hortor {
// namespace servo {

// Error ServoAccessor::Init() {
//   CHECK(raw_adapter_.Init(table_, sizeof(table_)));
//   CHECK(raw_adapter_.LinkAccessor(*this));
//   CHECK(LoadEeprom());
//   return Error::kOk;
// }
// Error ServoAccessor::GetStatus(uint8_t& status) { return Error::kOk; }
// Error ServoAccessor::RecoveryEeprom() { return Error::kOk; }
// Error ServoAccessor::LoadEeprom() { return Error::kOk; }
// Error ServoAccessor::StoreEeprom() { return Error::kOk; }
// Error ServoAccessor::StoreEeprom(const uint8_t address, const uint8_t size) {
//   return Error::kOk;
// }
// }  // namespace servo
// }  // namespace hortor
