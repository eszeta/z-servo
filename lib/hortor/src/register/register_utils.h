 ...
 */
template <typename T>
constexpr T GetValue(const RegisterField<T>& field, const T data) noexcept {
 ...
 */
template <typename T>
constexpr void SetValue(const RegisterField<T>& field,
                        const T data,
                        const T value,
                        T& out) noexcept {
 ...
 */
template <typename T>
constexpr auto GetCombinedValue(const RegisterField<T>& high_field,
 ...
 */
template <typename T>
constexpr void SetCombinedValue(const RegisterField<T>& high_field,
                                const RegisterField<T>& low_field,
                                const T high_data,
                                const T low_data,
