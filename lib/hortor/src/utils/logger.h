...
#define LOG_DEBUG(format, ...)                                                                   \
  do {                                                                                           \
    if (::hortor::utils::Logger::ShouldOutput(::hortor::utils::LogLevel::kDebug)) {              \
      ::hortor::utils::Logger::Printf(::hortor::utils::LogLevel::kDebug, format, ##__VA_ARGS__); \
    }                                                                                            \
  } while (0)
...
#define LOG_INFO(format, ...)                                                                   \
  do {                                                                                          \
    if (::hortor::utils::Logger::ShouldOutput(::hortor::utils::LogLevel::kInfo)) {              \
      ::hortor::utils::Logger::Printf(::hortor::utils::LogLevel::kInfo, format, ##__VA_ARGS__); \
    }                                                                                           \
  } while (0)
...
#define LOG_WARN(format, ...)                                                                   \
  do {                                                                                          \
    if (::hortor::utils::Logger::ShouldOutput(::hortor::utils::LogLevel::kWarn)) {              \
      ::hortor::utils::Logger::Printf(::hortor::utils::LogLevel::kWarn, format, ##__VA_ARGS__); \
    }                                                                                           \
  } while (0)
...
#define LOG_ERROR(format, ...)                                                                   \
  do {                                                                                           \
    if (::hortor::utils::Logger::ShouldOutput(::hortor::utils::LogLevel::kError)) {              \
      ::hortor::utils::Logger::Printf(::hortor::utils::LogLevel::kError, format, ##__VA_ARGS__); \
    }                                                                                            \
  } while (0)
...
#define LOG_DEBUG_IF(condition, format, ...)                                                       \
  do {                                                                                             \
    if ((condition) && ::hortor::utils::Logger::ShouldOutput(::hortor::utils::LogLevel::kDebug)) { \
      ::hortor::utils::Logger::Printf(::hortor::utils::LogLevel::kDebug, format, ##__VA_ARGS__);   \
    }                                                                                              \
  } while (0)
...
#define LOG_INFO_IF(condition, format, ...)                                                       \
  do {                                                                                            \
    if ((condition) && ::hortor::utils::Logger::ShouldOutput(::hortor::utils::LogLevel::kInfo)) { \
      ::hortor::utils::Logger::Printf(::hortor::utils::LogLevel::kInfo, format, ##__VA_ARGS__);   \
    }                                                                                             \
  } while (0)
...
#define LOG_WARN_IF(condition, format, ...)                                                       \
  do {                                                                                            \
    if ((condition) && ::hortor::utils::Logger::ShouldOutput(::hortor::utils::LogLevel::kWarn)) { \
      ::hortor::utils::Logger::Printf(::hortor::utils::LogLevel::kWarn, format, ##__VA_ARGS__);   \
    }                                                                                             \
  } while (0)
...
#define LOG_ERROR_IF(condition, format, ...)                                                       \
  do {                                                                                             \
    if ((condition) && ::hortor::utils::Logger::ShouldOutput(::hortor::utils::LogLevel::kError)) { \
      ::hortor::utils::Logger::Printf(::hortor::utils::LogLevel::kError, format, ##__VA_ARGS__);   \
    }                                                                                              \
  } while (0)
