...
void test_calculator_addition(void) { TEST_ASSERT_EQUAL(32, calc.add(25, 7)); }
...
void test_calculator_division(void) { TEST_ASSERT_EQUAL(32, calc.div(96, 3)); }

void test_expensive_operation(void) { TEST_IGNORE(); }
